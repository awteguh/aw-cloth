...
export const products: Product[] = [
  ...
  {
    id: "4",
    slug: "celana-pendek-semi-wool",
    name: "Celana Pendek Semi Wool",
    category: "celana-pendek",
    price: 159000,
    oldPrice: 189000,
    description:
      "Celana pendek bahan semi wool motif herringbone navy. Kain tebal namun tetap adem, jatuhnya rapi dan tidak mudah kusut. Cocok untuk tampilan kasual yang terlihat lebih berkelas.",
    images: [
      "/images/celana-semi-wool-v3.jpg",
      "/images/celana-semi-wool-kain-v3.jpg",
    ],
    sizes: ["28", "30", "32", "34"],
    colors: ["Navy"],
    featured: true,
